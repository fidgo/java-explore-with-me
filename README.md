...
1. Создание
2. Ожидание публикации. В статус ожидания публикации событие переходит сразу после создания.(State.PENDING)
...
`request_moderation` — характеризует необходимость пре-модерация заявок на участие. Если true, то все заявки будут
