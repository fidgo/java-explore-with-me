...
DROP TABLE IF EXISTS users_permission_policy CASCADE;
...
(
    ...
    CONSTRAINT comments_creator_fk FOREIGN KEY (creator_id) REFERENCES users (id),
    CONSTRAINT comments_event_fk FOREIGN KEY (event_id) REFERENCES events (id)
);

CREATE TABLE IF NOT EXISTS users_permission_policy
(
    id      BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    user_id BIGINT                                  NOT NULL,
    status  VARCHAR(20)                             NOT NULL,

    CONSTRAINT pk_users_permission_policy PRIMARY KEY (id),
    CONSTRAINT users_permission_policy_fk FOREIGN KEY (user_id) REFERENCES users (id),
    CONSTRAINT unique_users_permission_policy_user_id unique (user_id)
);
